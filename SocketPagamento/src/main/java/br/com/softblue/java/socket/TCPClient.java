...
public class TCPClient {
	...
	private static String enviarPagamento(String nome, String numeroCartao, YearMonth dataValidadeCartao, int parcelas,
			double valor, BufferedReader in, PrintWriter out) throws IOException {
